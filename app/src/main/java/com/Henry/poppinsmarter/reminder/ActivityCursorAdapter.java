...
public class ActivityCursorAdapter extends CursorAdapter{
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return LayoutInflater.from(context).inflate(R.layout.history_items, parent, false);
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (active != null){
            ...
            mActiveImage.setImageResource(R.drawable.ic_access_time_grey600_24dp);
        }
        //Handling the null values on date time etc.. to prevent null pointer when binding
    ...
    public void setActiveImage(String active){
        if(active.equals("true")){
            ...
            mActiveImage.setImageResource(R.drawable.ic_stat_name);
        }
    }
